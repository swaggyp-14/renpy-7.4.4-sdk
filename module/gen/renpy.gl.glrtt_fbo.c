 ...
 *         finally:
 */
    __pyx_t_13 = __Pyx_PyInt_As_GLsizei(__pyx_v_w); if (unlikely((__pyx_t_13 == ((GLsizei)-1)) && PyErr_Occurred())) __PYX_ERR(0, 108, __pyx_L4_error)
    __pyx_t_12 = __Pyx_PyInt_As_GLsizei(__pyx_v_h); if (unlikely((__pyx_t_12 == ((GLsizei)-1)) && PyErr_Occurred())) __PYX_ERR(0, 108, __pyx_L4_error)
    __pyx_v_5renpy_4uguu_2gl_glCopyTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 0, 0, __pyx_t_13, __pyx_t_12, 0);
  }

  /* "renpy/gl/glrtt_fbo.pyx":111
 * 
 *         finally:
 *             glBindFramebuffer(GL_FRAMEBUFFER, root_fbo)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_5renpy_2gl_9glrtt_fbo_6FboRtt_9get_size_limit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dimension)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_size_limit", 1, 2, 2, 1); __PYX_ERR(0, 114, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_size_limit") < 0)) __PYX_ERR(0, 114, __pyx_L3_error)
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_size_limit", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 114, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_5renpy_2gl_9glrtt_fbo_6FboRtt_8get_size_limit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_dimension) {
  ...
  /* "renpy/gl/glrtt_fbo.pyx":115
 * 
 *     def get_size_limit(self, dimension):
 *         return self.size_limit             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_self, __pyx_n_s_size_limit); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 115, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *         return self.size_limit
 */
  __pyx_tuple__9 = PyTuple_Pack(2, __pyx_n_s_self, __pyx_n_s_dimension); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 114, __pyx_L1_error)
 ...
 *         return self.size_limit
 */
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_5renpy_2gl_9glrtt_fbo_6FboRtt_9get_size_limit, 0, __pyx_n_s_FboRtt_get_size_limit, NULL, __pyx_n_s_renpy_gl_glrtt_fbo, __pyx_d, ((PyObject *)__pyx_codeobj__10)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (__Pyx_SetNameInClass(__pyx_t_3, __pyx_n_s_get_size_limit, __pyx_t_4) < 0) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
